                    ...
                    <table class="table table-condensed table-striped">
                        <thead>
                            <tr>
                                ...
                                <th>Name</th> <th>Description</th> <th>Nullable</th> <th>Subscriber_count</th>
                        ...
                        <tbody>
                            @foreach($projects as $project)
                                <tr>
                                    ...
                                    <td>{{$project->name}}</td> <td>{{$project->description}}</td> <td>{{$project->nullable}}</td> <td>{{$project->subscriber_count}}</td>
